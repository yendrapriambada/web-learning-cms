...
<head>
    ...
    <title>Data Nilai Worksheet Per Tahapan Pembelajaran | Pendidikan IPA Terpadu</title>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Data Nilai Worksheet Per Tahapan Pembelajaran
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php $no=1; foreach ($scoreTahapan as $s) :?>
                                            <tr>
                                                ...
                                                <td class="text-center align-top"><?= $s->tahapan_pembelajaran?></td>
                                                <td class="text-center align-top"><?= $s->jumlah_soal?></td>
                                                <td class="text-center align-top"><?= $s->total_skor?></td>
                                            </tr>
                                        <?php $no++; endforeach; ?>
                                    </tbody>
                                </table>
