...
<head>
    ...
    <title>Tambah Data Pertemuan | Pendidikan IPA Terpadu</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br><br><br>
                            <div class="mt-3">
                                <form id="form_advanced_validation" method="POST" action="<?= base_url().'guru/Pertemuan/do_create'?>">
                                    
                                    <!-- Nomor Pertemuan -->
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" class="form-control" id="no_pertemuan" name="no_pertemuan" required/>
                                            <label class="form-label" for="no_pertemuan">Nomor Pertemuan<span class="text-danger">*</span></label>
                                        </div>
                                        <div class="help-info">Contoh: 1, 2, 3, dst. nomor pertemuan yang sudah di buat tidak dapat dibuat ulang</div>
                                    </div>
                                    <?= form_error("no_pertemuan",
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="judul_pertemuan" name="judul_pertemuan" required/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="radio" class="with-gap" name="status" id="tidak-aktif" value="0" checked required>
                                        <label for="tidak-aktif">Tidak Aktif</label>
                                        
                                        <input type="radio" class="with-gap" name="status" id="aktif" value="1" required>
