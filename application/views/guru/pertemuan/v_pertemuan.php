...
<head>
    ...
    <title>Data Proyek | Pendidikan IPA Terpadu</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <!-- button create -->
                            <a class="dropdown-item btn btn-primary" href="<?= base_url().'guru/Pertemuan/create/'?>" title="Tambah Data Pertemuan">
                                    ...
                                    <tbody>
                                        <?php $no=1; foreach ($data as $d) :?>
                                            <tr>
                                                ...
                                                <td><?= $d->tema_proyek?></td>
                                                <td><?= $d->judul_pertemuan?></td>
                                                <td><?= $d->deskripsi_pertemuan?></td>
                                                <td>
                                                    <?php 
                                                        if($d->status_pertemuan == 0) { 
                                                ...
                                                <td>
                                                    ...
                                                    <a class="dropdown-item btn btn-danger" onclick="return confirm ('Apakah Anda Yakin Akan Menghapus Data ini ?')"  href="<?= base_url().'guru/Pertemuan/delete/'. $d->id_pertemuan?>" title="Hapus Permanen Data Pertemuan">
