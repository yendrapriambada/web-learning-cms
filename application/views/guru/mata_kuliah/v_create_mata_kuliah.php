...
<head>
    ...
    <title>Tambah Data Mata Kuliah | Pendidikan IPA Terpadu</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br><br><br>
                            <div class="mt-3">
                                <form id="form_advanced_validation" method="POST" action="<?= base_url().'guru/MataKuliah/do_create'?>">
                                    <!-- Program Studi -->
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" class="form-control" id="bobot_sks" name="bobot_sks" required/>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="form-control" name="jenjang" id="jenjang" required>
                                                <option value="">-- Silahkan Pilih Jenjang Mata Kuliah --</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="radio" class="with-gap" name="status" id="wajib" value="wajib" required>
                                        <label for="wajib">Wajib</label>
                                        
                                        <input type="radio" class="with-gap" name="status" id="pilihan" value="pilihan" required>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="url" class="form-control" id="link_rps" name="link_rps"/>
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <br>
                                        <div class="form-line">
                                            <input type="url" class="form-control" id="link_modul" name="link_modul"/>
