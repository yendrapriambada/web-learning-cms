...
<head>
    ...
    <title>Tambah Data Sumber Belaajr | Pendidikan IPA Terpadu</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br><br><br>
                            <div class="mt-3">
                                <form id="form_advanced_validation" method="POST" action="<?= base_url().'guru/SumberBelajar/do_create'?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <div class="help-info">Contoh: Modul Materi</div>
                                    </div>
                                    
                                    <!-- Thumbnail -->
                                    <div class="form-outline mb-4">
                                        <label for="thumbnail" class="form-label">Upload Thumbnail <span class="text-danger">*</span></label>
                                        <input class="form-control" type="file" id="thumbnail" name="thumbnail" accept=".jpg,.jpeg,.png" required/>
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <input class="form-control" type="file" id="pdf_sumber_belajar" name="pdf_sumber_belajar" accept=".pdf" required/>
                                        <small>Keterangan:</small>
                                        <ul style="list-style-type:circle;margin-bottom: 20px">
