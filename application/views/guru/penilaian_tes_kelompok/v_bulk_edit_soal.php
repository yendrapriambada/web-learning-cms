...
<head>
    ...
    <title>Bulk Edit Soal — Kelompok <?= htmlspecialchars($no_kelompok)?> | Pendidikan IPA Terpadu</title>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="breadcrumb-nav">
                    ...
                    <a href="<?= base_url().'guru/PenilaianTesKelompok/detail/'.urlencode($no_kelompok).'/'.$soal_key?>">Detail Soal</a> &raquo;
                    Bulk Edit
                </div>
                <h2>Bulk Edit Soal — Kelompok <?= htmlspecialchars($no_kelompok)?></h2>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <a href="<?= base_url().'guru/PenilaianTesKelompok/detail/'.urlencode($no_kelompok).'/'.$soal_key?>" class="btn btn-default waves-effect m-b-20">
                            ...
                            <div class="warn-banner">
                                ...
                                Nilai &amp; feedback yang Anda isi di bawah akan diterapkan ke <b>semua <?= $jumlah_anggota?> anggota kelompok <?= htmlspecialchars($no_kelompok)?></b> untuk soal ini, menggantikan nilai/feedback masing-masing siswa sebelumnya. Anggota yang belum pernah mengerjakan soal ini akan otomatis dibuatkan catatan nilai baru.
                            </div>
                            ...
                            <form method="POST" action="<?= base_url().'guru/PenilaianTesKelompok/do_bulk_soal'?>">
                                ...
                                <button type="submit" class="btn btn-success btn-lg waves-effect m-t-20"
                                        onclick="return confirm('Terapkan nilai ini ke semua <?= $jumlah_anggota?> anggota kelompok <?= htmlspecialchars(addslashes($no_kelompok))?> untuk soal ini?')">
                                    <i class="material-icons">save</i> Terapkan ke Semua Anggota
                                </button>
                                <a href="<?= base_url().'guru/PenilaianTesKelompok/detail/'.urlencode($no_kelompok).'/'.$soal_key?>" class="btn btn-default btn-lg waves-effect m-l-10 m-t-20">Batal</a>
                            </form>
                        </div>
                    </div>
                </div>
