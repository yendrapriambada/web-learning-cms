...
<head>
    ...
    <title>Edit Data Jawaban Essai | Pendidikan IPA Terpadu</title>
                            ...
                            <div class="mt-3">
                                <form id="form_advanced_validation" method="POST" action="<?= base_url().'guru/JawabanSiswa/do_edit'?>">
                                    ...
                                    <div class="form-group form-float">
                                        <label class="form-label mb-3" for="deksripsi_soal">Deskripsi Soal</label><br><br>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" disabled style="border: 1px grey solid; padding: 20px"><?= $dataById->deksripsi_soal?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" class="form-control" id="nilai" name="nilai" value="<?= $dataById->nilai?>" required/>
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <textarea id="ckeditor1" name="feedback"><?= $dataById->feedback?></textarea>
                                    </div>

                                    <!-- Submit button -->
                                    <button class="btn btn-primary waves-effect" type="submit">SUBMIT</button>
                                    <a href="<?= base_url().'guru/JawabanSiswa'?>" class="btn btn-danger waves-effect" type="submit">BATAL</a>
                                </form>
                            </div>
                        </div>
                    </div>
