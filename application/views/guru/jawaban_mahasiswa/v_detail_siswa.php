...
<head>
    ...
    <title>Kelompok <?= htmlspecialchars($no_kelompok)?> — Soal <?= $soal->no_soal?> | Pendidikan IPA Terpadu</title>
    ...
    <style>
        ...
        .siswa-row .siswa-links a { font-size: 12px; margin-right: 12px; }
        ...
        <div class="container-fluid">
            <div class="block-header">
                ...
                <div class="detail-header">
                    ...
                    <a href="<?= base_url().'guru/JawabanMahasiswa/bulk_soal/'.urlencode($no_kelompok).'/'.$id_soal?>" class="btn btn-success waves-effect">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <a href="<?= base_url().'guru/JawabanMahasiswa/soal/'.urlencode($no_kelompok)?>" class="btn btn-default waves-effect m-b-20">
                            ...
                            <p class="text-muted m-b-20" style="font-size:13px;">
                                Daftar jawaban tiap siswa untuk soal ini (hanya lihat). Untuk mengubah jawaban/nilai/feedback sekaligus untuk semua anggota kelompok, gunakan tombol <b>Bulk Edit Soal Ini</b> di atas.
                            </p>
                            ...
                            <div class="siswa-row">
                                <div class="siswa-main">
                                    ...
                                    <?php if ($sw['id_jawaban_essai']): ?>
                                        <span class="sudah-menjawab">Sudah mengirim jawaban</span>
                                        <?php if ($sw['jawaban_text']): ?>
                                        <p class="siswa-jawaban"><?= htmlspecialchars($sw['jawaban_text'])?></p>
                                        <?php endif; ?>
                                        <div class="siswa-links">
                                            <?php if ($sw['jawaban_gambar']): ?>
                                            <a href="<?= base_url().'assets/jawaban_gambar/'.$sw['jawaban_gambar']?>" target="_blank">Lihat Gambar</a>
                                            <?php endif; ?>
                                            <?php if ($sw['jawaban_file']): ?>
                                            <a href="<?= base_url().'assets/jawaban_file/'.$sw['jawaban_file']?>" target="_blank">Lihat Dokumen</a>
                                            <?php endif; ?>
                                        </div>
                                        <?php if ($sw['feedback']): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <span class="belum-menjawab">Belum mengirim jawaban</span>
                                    <?php endif; ?>
                                </div>
                                <div class="siswa-side">
                                    ...
                                    <?php if ($sw['id_jawaban_essai']): ?>
                                    <br>
                                    <a href="<?= base_url().'guru/JawabanMahasiswa/hapus/'.$sw['id_jawaban_essai'].'/'.urlencode($no_kelompok).'/'.$id_soal?>"
