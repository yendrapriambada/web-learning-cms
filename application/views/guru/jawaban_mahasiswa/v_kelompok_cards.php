...
<head>
    ...
    <title>Jawaban Mahasiswa/i — Per Kelompok | Pendidikan IPA Terpadu</title>
        ...
        <div class="container-fluid">
                        ...
                        <div class="body">
                            ...
                            <div class="filter-row">
                                <div class="view-toggle btn-group" role="group">
                                    <a href="<?= base_url().'guru/JawabanSiswa'?>" class="btn btn-default">Tampilan Tabel</a>
                                    <a href="<?= base_url().'guru/JawabanMahasiswa'?>" class="btn active">Tampilan Kelompok</a>
                                </div>
                                <form method="GET" action="<?= base_url().'guru/JawabanMahasiswa'?>" class="filter-row-end">
                            ...
                            <p class="text-muted m-t-15 m-b-0">
                                Klik kartu kelompok untuk melihat daftar soal yang sudah dikerjakan, lalu klik salah satu soal untuk melihat &amp; menilai jawaban masing-masing anggota.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="kelompok-grid">
                ...
                <div class="kelompok-col">
                    <a class="kelompok-tile <?= $status?>" href="<?= base_url().'guru/JawabanMahasiswa/soal/'.urlencode($c['no_kelompok'])?>">
                        ...
                        <p class="text-muted m-b-0" style="font-size:13px;">Belum ada jawaban dikirim.</p>
                        <?php else: ?>
