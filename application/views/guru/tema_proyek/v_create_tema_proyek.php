...
<head>
    ...
    <title>Tambah Data Tema Proyek | Pendidikan IPA Terpadu</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br><br><br>
                            <div class="mt-3">
                                <form id="form_advanced_validation" method="POST" action="<?= base_url().'guru/TemaProyek/do_create'?>">
                                    
                                    <!-- Tema Proyek -->
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="tema_proyek" name="tema_proyek" required/>
                                            <label class="form-label" for="tema_proyek">Tema Proyek<span class="text-danger">*</span></label>
                                        </div>
                                        <div class="help-info">Contoh: Tema 1, Tema 2, Tema 3, dst.</div>
                                    </div>
                                    <?= form_error("tema_proyek",
