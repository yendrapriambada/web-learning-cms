                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body m-l-30 m-r-30">
                            ...
                            <?php } ?>
                            <!-- button create -->
                            <a class="dropdown-item btn btn-primary" href="<?= base_url().'guru/Diskusi/create/'?>" title="Tambah Komentar">
                                    ...
                                    <tbody>
                                        <?php $no=1; foreach ($data as $d) :?>
                                            <tr>
                                                ...
                                                <td><?= $d->updated_at?></td>
                                                <td>
                                                    <a class="dropdown-item btn btn-warning" onclick="return confirm ('Apakah Anda Yakin Akan Mengedit Data ini ?')"  href="<?= base_url().'guru/Diskusi/edit/'. $d->id_diskusi?>" title="Edit Komentar">
                                                        <i class="material-icons">edit</i></a>
                                                    <a class="dropdown-item btn btn-danger" onclick="return confirm ('Apakah Anda Yakin Akan Menghapus Data ini ?')"  href="<?= base_url().'guru/Diskusi/delete/'. $d->id_diskusi?>" title="Hapus Permanen Komentar">
