                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body m-l-30 m-r-30">
                            ...
                            <!-- Pertemuan -->
                            <form id="form_advanced_validation" method="POST" action="<?= base_url().'guru/Diskusi/do_pilih_review_diskusi'?>">
                                <!-- Pertemuan -->
                                <div class="form-group">
                                    <div class="form-line">
                                        <span class="text-danger">Diskusi pada pertemuan berapa yang akan anda review?</span>
                                        <br><br>
                                        <select class="form-control" name="id_pertemuan" id="id_pertemuan" required>
                                            <option value="">-- Pilih Pertemuan Komentar akan ditampilkan <span class="text-danger">*</span> --</option>
                                ...
                                <!-- Submit button -->
                                <button class="btn btn-primary waves-effect" type="submit">Lihat Komentar</button>
                            </form>
                        </div>
                    </div>
                </div>
