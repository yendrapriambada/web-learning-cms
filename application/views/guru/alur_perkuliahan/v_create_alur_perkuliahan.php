...
<head>
    ...
    <title>Tambah Data Alur Perkualiahan | Pendidikan IPA Terpadu</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br><br><br>
                            <div class="mt-3">
                                <form id="form_advanced_validation" method="POST" action="<?= base_url().'guru/AlurPerkuliahan/do_create'?>">
                                    <!-- Mata Kuliah -->
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="form-control" name="id_mata_kuliah" id="id_mata_kuliah"required>
                                                <option value="">-- Silahkan Pilih Mata Kuliah <span class="text-danger">*</span> --</option>
