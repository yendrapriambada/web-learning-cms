...
<head>
    ...
    <title>Edit Data Permasalahan | Pendidikan IPA Terpadu</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br><br><br>
                            <div class="mt-3">
                                <form id="form_advanced_validation" method="POST" action="<?= base_url().'guru/Permasalahan/do_edit'?>" enctype="multipart/form-data">
                                    <!-- Id Pertemuan -->
                                    <input type="hidden" name="id_permasalahan" value="<?= $dataById->id_permasalahan?>">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="tahapan_pembelajaran" name="tahapan_pembelajaran" value="<?= $dataById->tahapan_pembelajaran?>" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="judul_permasalahan" name="judul_permasalahan" value="<?= $dataById->judul_permasalahan?>"/>
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <textarea id="ckeditor1" name="deskripsi_permasalahan">
                                            <?= $dataById->deskripsi_permasalahan?>
                                        </textarea>
                                    </div>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" class="form-control" id="jumlah_soal" name="jumlah_soal" value="<?= $dataById->jumlah_soal?>" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="url" class="form-control" id="link_permasalahan" name="link_permasalahan" value="<?= $dataById->link_permasalahan?>"/>
