...
<head>
    ...
    <title>Data Soal Essai Worksheet | Pendidikan IPA Terpadu</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <!-- button create -->
                            <a class="dropdown-item btn btn-primary" href="<?= base_url().'guru/SoalEssai/create/'?>" title="Tambah Data Soal Essai">
                                    ...
                                    <tbody>
                                        <?php $no=1; foreach ($data as $d) :?>
                                            <tr>
                                                ...
                                                <td><?= $d->no_soal?></td>
                                                <td><?= $d->deksripsi_soal?></td>
                                                <td><?= $d->type_form?></td>
                                                <td><?= $d->created_at?></td>
                                                <td><?= $d->updated_at?></td>
                                                <td>
                                                    <a class="dropdown-item btn btn-warning" onclick="return confirm ('Apakah Anda Yakin Akan Mengedit Data ini ?')"  href="<?= base_url().'guru/SoalEssai/edit/'. $d->id_soal_essai?>" title="Edit Data Soal Essai">
                                                        <i class="material-icons">edit</i></a>
                                                    <a class="dropdown-item btn btn-danger" onclick="return confirm ('Apakah Anda Yakin Akan Menghapus Data ini ?')"  href="<?= base_url().'guru/SoalEssai/delete/'. $d->id_soal_essai?>" title="Hapus Permanen Data Soal Essai">
