...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jul 31, 2024 at 02:14 AM
...
(3, 33, 7, '', NULL, NULL, 0, '<p>kerjakan</p>\r\n', '2024-07-28 10:11:22', '2024-07-31 06:22:51'),
...
(13, 2, 9, 'kuku', NULL, NULL, 89, '', '2024-07-31 06:21:43', '2024-07-31 06:24:27'),
(14, 4, 9, 'kuku', NULL, NULL, NULL, NULL, '2024-07-31 06:21:43', NULL),
(15, 5, 9, 'kuku', NULL, NULL, NULL, NULL, '2024-07-31 06:21:43', NULL),
(16, 6, 9, 'kuku', NULL, NULL, 80, '', '2024-07-31 06:21:43', '2024-07-31 06:24:51'),
(17, 7, 9, 'kiki', NULL, NULL, NULL, NULL, '2024-07-31 06:22:03', NULL),
(18, 8, 9, 'kiki', NULL, NULL, NULL, NULL, '2024-07-31 06:22:03', NULL),
(19, 9, 9, 'kiki', NULL, NULL, 75, '', '2024-07-31 06:22:03', '2024-07-31 06:26:06'),
(20, 10, 9, 'kiki', NULL, NULL, NULL, NULL, '2024-07-31 06:22:03', NULL);
...
INSERT INTO `tb_score` (`id_score`, `id_user`, `score_pretest`, `score_posttest`, `score_pertemuan`, `created_at`, `updated_at`) VALUES
(1, 7, 80, 90, 60, '2024-07-31', NULL);
...
(9, 1, 'Lady', 'Universitas Pendidikan Indonesia', 'lady@gmail.com', '2024-07-05', 'P', 'da96daa4caa0884f0959d86b443d6893.jpg', 'lady', '1729bc477f7b098b508c1e99269c74a1', '2024-07-31 06:20:10', '2024-07-31 06:21:15');
...
--
-- Stand-in structure for view `v_nilai_worksheet`
-- (See below for the actual view)
--
CREATE TABLE `v_nilai_worksheet` (
`id_user` int(11)
,`nama_lengkap` varchar(255)
,`jenis_kelamin` char(1)
,`username` varchar(50)
...
,`id_pertemuan` int(11)
,`no_pertemuan` int(11)
,`nilai_per_pertemuan` decimal(32,0)
...
--
-- Stand-in structure for view `v_total_score`
-- (See below for the actual view)
--
CREATE TABLE `v_total_score` (
`id_user` int(11)
,`score_pretest` int(11)
,`score_posttest` int(11)
,`score_total_worksheet` decimal(33,0)
,`total_score` decimal(34,0)
);
...
--
-- Structure for view `v_nilai_worksheet`
--
...
--
-- Structure for view `v_total_score`
--
...
--
ALTER TABLE `tb_jawaban_essai`
  MODIFY `id_jawaban_essai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
