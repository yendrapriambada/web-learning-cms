...
CREATE TABLE `tb_jawaban_essai` (
  ...
  KEY `FK_tb_jawaban_essai` (`id_user`),
  KEY `FK_tb_jawaban_essai2` (`id_soal`),
  CONSTRAINT `FK_tb_jawaban_essai` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`),
  CONSTRAINT `FK_tb_jawaban_essai2` FOREIGN KEY (`id_soal`) REFERENCES `tb_soal_essai` (`id_soal_essai`)
