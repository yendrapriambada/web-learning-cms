...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2024 at 02:19 AM
...
(8, 7, 'Pertemuan Ke-7', '', '0', '2024-06-28 07:56:08', NULL),
...
(1, 'input text', '2024-07-03 12:47:44', NULL),
(2, 'textarea', '2024-07-03 12:47:46', NULL),
(3, 'file', '2024-07-03 12:47:49', NULL),
(4, 'canva', '2024-07-03 12:48:00', NULL);
...
ALTER TABLE `tb_jawaban_essai`
  ...
  ADD KEY `FK_tb_jawaban_essai` (`id_user`),
  ADD KEY `FK_tb_jawaban_essai2` (`id_soal`);
...
--
ALTER TABLE `tb_jawaban_essai`
  MODIFY `id_jawaban_essai` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_permasalahan`
  MODIFY `id_permasalahan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tb_soal_essai`
  MODIFY `id_soal_essai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `tb_jawaban_essai`
  ADD CONSTRAINT `FK_tb_jawaban_essai` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`),
  ADD CONSTRAINT `FK_tb_jawaban_essai2` FOREIGN KEY (`id_soal`) REFERENCES `tb_soal_essai` (`id_soal_essai`);
