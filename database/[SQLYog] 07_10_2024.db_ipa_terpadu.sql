...
MySQL - 5.5.5-10.4.27-MariaDB : Database - ipar7647_db_ipa_terpadu
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ipar7647_db_ipa_terpadu` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;

USE `ipar7647_db_ipa_terpadu`;

/*Table structure for table `tb_alur_pembelajaran` */

DROP TABLE IF EXISTS `tb_alur_pembelajaran`;

CREATE TABLE `tb_alur_pembelajaran` (
  `id_alur_pembelajaran` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tb_diskusi` (
  ...
  KEY `FK_tb_diskusi` (`id_user`),
  KEY `FK_tb_diskusi2` (`id_pertemuan`),
  CONSTRAINT `FK_tb_diskusi` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`),
  CONSTRAINT `FK_tb_diskusi2` FOREIGN KEY (`id_pertemuan`) REFERENCES `tb_pertemuan` (`id_pertemuan`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `tb_diskusi` */

insert  into `tb_diskusi`(`id_diskusi`,`id_user`,`id_pertemuan`,`komentar`,`created_at`,`updated_at`) values (2,2,1,'Seperti mati lampu ya sayang, sperti mati lampu....','2024-07-18 10:06:03',NULL),(3,2,2,'Sampai kapan kau gantung cerita cintaku, memberi harapan','2024-07-18 10:06:19','2024-07-18 10:15:20'),(4,2,1,'Seperti mati lampu ya sayang, sperti mati lampu. cintaku padamu ya sayang','2024-07-18 10:09:22',NULL),(5,2,1,'iya nanti kami kesana','2024-07-18 11:29:02',NULL),(7,16,1,'ibu ibu ibu','2024-10-07 05:35:58',NULL);

/*Table structure for table `tb_jawaban_essai` */

DROP TABLE IF EXISTS `tb_jawaban_essai`;

CREATE TABLE `tb_jawaban_essai` (
  `id_jawaban_essai` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id_jawaban_essai`),
  KEY `FK_tb_jawaban_essai` (`id_soal`),
  KEY `FK_tb_jawaban_essai2` (`id_user`),
  CONSTRAINT `FK_tb_jawaban_essai` FOREIGN KEY (`id_soal`) REFERENCES `tb_soal_essai` (`id_soal_essai`),
  CONSTRAINT `FK_tb_jawaban_essai2` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `tb_jawaban_essai` */

insert  into `tb_jawaban_essai`(`id_jawaban_essai`,`id_soal`,`id_user`,`jawaban_text`,`jawaban_file`,`jawaban_gambar`,`nilai`,`feedback`,`created_at`,`updated_at`) values (33,2,15,'Optimalisasi pemanfaatan sumber daya alam bukanlah hal yang mudah. Banyak kendala yang terjadi di lapangan terkait dengan pemanfaatannya. Dari aspek teknologi,',NULL,NULL,80,'<p>Tolong Perbaiki lagi agar sempurna</p>\r\n','2024-10-06 10:03:28','2024-10-06 10:05:31'),(34,4,15,'Karna banyak masalah',NULL,NULL,70,'','2024-10-06 10:03:28','2024-10-07 05:38:05'),(35,5,15,'Optimalisasi pemanfaatan sumber daya alam bukanlah hal yang mudah. Banyak kendala yang terjadi di lapangan terkait dengan pemanfaatannya. Dari aspek teknologi,',NULL,NULL,90,'','2024-10-06 10:03:28','2024-10-07 05:38:13'),(36,6,15,'Optimalisasi pemanfaatan sumber daya alam bukanlah hal yang mudah. Banyak kendala yang terjadi di lapangan terkait dengan pemanfaatannya. Dari aspek teknologi,',NULL,NULL,86,'','2024-10-06 10:03:28','2024-10-07 05:38:22'),(37,7,15,'Optimalisasi pemanfaatan sumber daya alam bukanlah hal yang mudah. Banyak kendala yang terjadi di lapangan terkait dengan pemanfaatannya. Dari aspek teknologi,',NULL,NULL,65,'','2024-10-06 10:03:47','2024-10-07 05:38:41'),(38,8,15,'Optimalisasi pemanfaatan sumber daya alam bukanlah hal yang mudah. Banyak kendala yang terjadi di lapangan terkait dengan pemanfaatannya. Dari aspek teknologi,',NULL,NULL,98,'','2024-10-06 10:03:47','2024-10-07 05:38:49'),(39,9,15,'Optimalisasi pemanfaatan sumber daya alam bukanlah hal yang mudah. Banyak kendala yang terjadi di lapangan terkait dengan pemanfaatannya. Dari aspek teknologi,',NULL,NULL,65,'','2024-10-06 10:03:47','2024-10-07 05:38:58'),(40,10,15,'Optimalisasi pemanfaatan sumber daya alam bukanlah hal yang mudah. Banyak kendala yang terjadi di lapangan terkait dengan pemanfaatannya. Dari aspek teknologi,',NULL,NULL,54,'','2024-10-06 10:03:47','2024-10-07 05:39:06'),(41,71,15,NULL,'3c1ee221517ce6e51e3356ce879683e2.pdf',NULL,87,'','2024-10-06 10:03:47','2024-10-07 05:42:19'),(42,2,16,'lala',NULL,NULL,78,'','2024-10-07 05:35:26','2024-10-07 05:42:29'),(43,4,16,'lala',NULL,NULL,75,'','2024-10-07 05:35:26','2024-10-07 05:42:40'),(44,5,16,'lala',NULL,NULL,63,'','2024-10-07 05:35:26','2024-10-07 05:42:53'),(45,6,16,'lala',NULL,NULL,NULL,NULL,'2024-10-07 05:35:26',NULL),(46,7,16,'lolo',NULL,NULL,NULL,NULL,'2024-10-07 05:35:46',NULL),(47,8,16,'lolo',NULL,NULL,NULL,NULL,'2024-10-07 05:35:46',NULL),(48,9,16,'lolo',NULL,NULL,NULL,NULL,'2024-10-07 05:35:46',NULL),(49,10,16,'lolo',NULL,NULL,NULL,NULL,'2024-10-07 05:35:46',NULL),(50,71,16,NULL,'2558336d355492d35e3564feaa33282b.pdf',NULL,NULL,NULL,'2024-10-07 05:35:46',NULL),(51,38,16,'enginge 2',NULL,NULL,NULL,NULL,'2024-10-07 05:36:27',NULL),(52,39,16,'enginge 2',NULL,NULL,65,'','2024-10-07 05:36:27','2024-10-07 05:43:11'),(53,40,16,'enginge 2',NULL,NULL,NULL,NULL,'2024-10-07 05:36:27',NULL),(54,41,16,'enginge 2',NULL,NULL,NULL,NULL,'2024-10-07 05:36:27',NULL),(55,31,16,'lalklk',NULL,NULL,NULL,NULL,'2024-10-07 05:37:10',NULL),(56,32,16,'lklk',NULL,NULL,NULL,NULL,'2024-10-07 05:37:10',NULL),(57,33,16,'lklk',NULL,NULL,NULL,NULL,'2024-10-07 05:37:10',NULL),(58,35,16,'lklk',NULL,NULL,NULL,NULL,'2024-10-07 05:37:10',NULL),(59,36,16,'lkkl',NULL,NULL,NULL,NULL,'2024-10-07 05:37:10',NULL),(60,34,16,NULL,'909312554e15efa11500192469564e82.pdf',NULL,NULL,NULL,'2024-10-07 05:37:10',NULL);

/*Table structure for table `tb_landing_page` */

DROP TABLE IF EXISTS `tb_landing_page`;

CREATE TABLE `tb_landing_page` (
  `id_landing_page` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `tb_landing_page` */
...
/*Data for the table `tb_pertemuan` */

insert  into `tb_pertemuan`(`id_pertemuan`,`no_pertemuan`,`judul_pertemuan`,`deskripsi_pertemuan`,`status`,`created_at`,`updated_at`) values (1,1,'Pertemuan Ke-1','Tujuan Proyek: Mengatasi permasalahan Sistem Irigasi','1','2024-06-27 14:58:53','2024-06-28 07:54:30'),(2,2,'Pertemuan Ke-2',NULL,'1','2024-06-27 14:58:55',NULL),(3,3,'Pertemuan Ke-3',NULL,'1','2024-06-27 14:58:58',NULL),(5,4,'Pertemuan Ke-4','','1','2024-06-28 07:55:09',NULL),(6,5,'Pertemuan Ke-5','','1','2024-06-28 07:55:21',NULL),(7,6,'Pertemuan Ke-6','','0','2024-06-28 07:55:36',NULL),(8,7,'Pertemuan Ke-7','','1','2024-06-28 07:56:08',NULL),(9,8,'Pertemuan Ke-8','','0','2024-06-28 07:56:16',NULL),(10,9,'Pertemuan Ke-9','','0','2024-06-28 07:56:26',NULL),(11,10,'Pertemuan Ke-10','','0','2024-06-28 07:56:33',NULL),(12,11,'Pertemuan Ke-11','','0','2024-06-28 07:56:41',NULL),(13,12,'Pertemuan Ke-12','','0','2024-06-28 07:58:18',NULL);
...
insert  into `tb_role_user`(`id_role_user`,`role_user`,`created_at`,`updated_at`) values (1,'Mahasiswa','2024-06-21 07:38:52',NULL),(2,'Dosen','2024-06-21 07:38:57',NULL);
...
DROP TABLE IF EXISTS `tb_soal_essai`;

CREATE TABLE `tb_soal_essai` (
  `id_soal_essai` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id_soal_essai`),
  KEY `FK_tb_soal_essai` (`id_permasalahan`),
  KEY `FK_tb_soal_essai2` (`tipe_jawaban`),
  CONSTRAINT `FK_tb_soal_essai` FOREIGN KEY (`id_permasalahan`) REFERENCES `tb_permasalahan` (`id_permasalahan`),
  CONSTRAINT `FK_tb_soal_essai2` FOREIGN KEY (`tipe_jawaban`) REFERENCES `tb_type_form` (`id_type_form`)
) ENGINE=InnoDB AUTO_INCREMENT=73 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `tb_soal_essai` */

insert  into `tb_soal_essai`(`id_soal_essai`,`id_permasalahan`,`no_soal`,`deksripsi_soal`,`tipe_jawaban`,`created_at`,`updated_at`) values (2,4,1,'Apa yang menjadi masalah utama pada artikel yang kamu baca?',2,'2024-07-03 14:38:01',NULL),(4,4,2,'Mengapa hal tersebut masalah pada gambar (a), (b) terjadi?',2,'2024-07-03 14:47:08',NULL),(5,4,3,'Bagaimana cara mengatasi permasalahan pada artikel menurutmu?',2,'2024-07-03 14:47:27',NULL),(6,4,4,'Tuliskan pengetahuan dan data pendukung yang mendasari jawabanmu di atas pada kolom di bawah ini (disertakan link sumber rujukannya)',2,'2024-07-03 14:47:51',NULL),(7,6,1,'Berdasarkan hasil wawancara, observasi dan studi dokumentasi, apa masalah inti yang perlu untuk kamu selidiki? (Nyatakan dalam bentuk pertanyaan)',2,'2024-07-03 14:48:10',NULL),(8,6,2,'Apa saja bukti-bukti yang menguatkan bahwa pertanyaan tersebut memang menjadi masalah di daerahmu?',2,'2024-07-03 14:48:26',NULL),(9,6,3,'Apa yang menjadi penyebab permasalahan tersebut?',2,'2024-07-03 14:48:42',NULL),(10,6,4,'Apa saja dampak yang muncul akibat permasalahan tersebut?',2,'2024-07-03 14:48:59',NULL),(11,7,1,'Carilah informasi lebih lanjut mengenai kedua alat dan sistem tersebut! Kamu dapat memulai dengan membuat pertanyaan dan menjawab pertanyaan pada kolom-kolom di bawah ini terkait dengan alat yang dibutuhkan untuk mengalirkan air dari tempat rendah ke tempat yang lebih tinggi tanpa energi listrik dan bahan bakar, jenis-jenis metode pengaliran air tanpa energi listrik dan bahan bakar, karakteristik setiap jenis metode pengaliran air tanpa energi listrik dan bahan bakar, faktor yang menyebabkan alat-alat tersebut efektif digunakan, dan biaya pembuatan untuk tiap jenisnya.',2,'2024-07-09 06:53:09',NULL),(12,7,2,'Dari beberapa prototipe yang kamu ketahui, jenis manakah yang terbaik menurutmu? Berikan alasanmu dengan mempertimbangkan aspek ekonomi dan lingkungan!',2,'2024-07-09 06:53:24',NULL),(13,7,3,'Dari beberapa metode distibusi air yang kamu ketahui, jenis manakah yang terbaik menurutmu? Berikan alasanmu dengan mempertimbangkan aspek ekonomi dan lingkungan!',2,'2024-07-09 06:53:58',NULL),(14,7,4,'Buatlah pertanyaan tambahan beserta jawabannya untuk mendapatkan informasi lebih tentang alat tersebut. Tuliskan pertanyaan dan jawabanmu dalam kolom berikut!',2,'2024-07-09 07:03:08',NULL),(15,7,5,'Sebelum merancang dan membuat proyek buatlah hipotesis penyelidikanmu pada kolom di bawah ini, berdasarkan informasi yang telah kamu peroleh sebelumnya. Tujuannya agar penyelidikan yang kamu lakukan menjadi terarah, memeriksa fakta dan hubungan variabel serta membimbing penelitianmu dalam pengujian dan penyesuaian fakta.',2,'2024-07-09 07:04:08','2024-07-09 07:05:06'),(16,8,1,'Keterangan / Penjelasan bagian-bagian produk:',2,'2024-07-09 07:06:54',NULL),(17,8,2,'Inovasi',2,'2024-07-09 07:07:13',NULL),(18,8,3,'Biaya yang dibutuhkan:',2,'2024-07-09 07:07:31',NULL),(19,9,1,'Nama alat',2,'2024-07-09 07:09:15',NULL),(20,9,2,'Tujuan',2,'2024-07-09 07:09:29',NULL),(21,9,3,'Alat dan Bahan',2,'2024-07-09 07:09:44',NULL),(22,9,4,'Buatlah langkah-langkah pembuatan proyek',2,'2024-07-09 07:10:02',NULL),(23,10,1,'[Uji Coba 1] Bagaimana cara menguji efektivitas prototipe/produk yang kamu buat?',2,'2024-07-09 07:11:11',NULL),(24,10,2,'[Uji Coba 1] Lakukan uji coba efektivitas produk sesuai dengan cara pengujian yang telah kamu susun! Sajikan hasil uji coba 1 yang telah kamu peroleh!',2,'2024-07-09 07:11:30',NULL),(25,10,3,'[Uji Coba 1] Evaluasi hasil dari uji coba 1 yang telah dilakukan! Adakah hal-hal yang perlu ditingkatkan dari desain produk yang diujicobakan tersebut? Jelaskan!',2,'2024-07-09 07:11:50',NULL),(26,10,4,'[Redisain] Berdasarkan hasil uji coba 1, Jelaskanlah perubahan apa yang akan kamu lakukan dari rancangan awal produkmu?',2,'2024-07-09 07:12:07',NULL),(27,10,5,'[Redisain] Bagaimana bentuk rancangan akhir produkmu? & Buatlah rancangan akhir tersebut!',2,'2024-07-09 07:12:23',NULL),(28,10,6,'[Uji Coba 2] Lakukan uji coba 2 dengan langkah yang sama dengan uji coba 1 untuk melihat efektivitas produk akhir yang kamu buat!',2,'2024-07-09 07:12:41',NULL),(29,10,7,'[Uji Coba 2] Berdasarkan hasil uji coba 2, apakah kesimpulanmu?',2,'2024-07-09 07:12:57',NULL),(30,11,1,'Gambar Desain produk',4,'2024-07-09 07:14:39',NULL),(31,11,2,'Keterangan / Penjelasan bagian-bagian produk:',2,'2024-07-09 07:14:55',NULL),(32,11,3,'Inovasi',2,'2024-07-09 07:15:09',NULL),(33,11,4,'Biaya yang dibutuhkan',2,'2024-07-09 07:15:24',NULL),(34,11,5,'Silahkan persiapkan bahan presentasi terkait inovasi/ kebaruan yang diperbaiki atau ditambahkan dari prototype yang telah di buat. Silahkan upload file PPT yang digunakan untuk presentasi.',3,'2024-07-09 07:15:43',NULL),(35,11,6,'[Uji Coba 2] Lakukan uji coba 2 dengan langkah yang sama dengan uji coba 1 untuk melihat efektivitas produk akhir yang kamu buat!',2,'2024-07-09 07:16:20',NULL),(36,11,7,'[Uji Coba 2] Berdasarkan hasil uji coba 2, apakah kesimpulanmu?',2,'2024-07-09 07:16:38',NULL),(37,12,1,'Silahkan beri tanggapan terhadap terhadap prototype yang telah dibuat',2,'2024-07-09 07:16:58',NULL),(38,13,1,'Apa yang menjadi masalah utama pada artikel yang kamu baca?',2,'2024-07-27 13:34:16',NULL),(39,13,2,'Mengapa hal tersebut masalah pada gambar tersebut?',2,'2024-07-27 13:34:36',NULL),(40,13,3,'Bagaimana cara mengatasi permasalahan pada artikel menurutmu?',2,'2024-07-27 13:34:56',NULL),(41,13,4,'Tuliskan pengetahuan dan data pendukung yang mendasari jawabanmu di atas pada kolom di bawah ini (disertakan link sumber rujukannya)',2,'2024-07-27 13:35:55',NULL),(42,14,1,'Berdasarkan hasil wawancara, observasi dan studi dokumentasi, apa masalah inti yang perlu untuk kamu selidiki? (Nyatakan dalam bentuk pertanyaan)',2,'2024-07-27 13:37:04',NULL),(43,14,2,'Apa saja bukti-bukti yang menguatkan bahwa pertanyaan tersebut memang menjadi masalah di daerahmu?',2,'2024-07-27 13:37:23',NULL),(44,14,3,'Apa yang menjadi penyebab permasalahan tersebut?',2,'2024-07-27 13:37:39',NULL),(45,14,4,'Apa saja dampak yang muncul akibat permasalahan tersebut?',2,'2024-07-27 13:37:55',NULL),(46,15,1,'Informasi Pendukung!.\r\nCarilah informasi lebih lanjut mengenai teknologi tersebut! Kamu dapat memulai dengan membuat pertanyaan dan menjawab pertanyaan pada kolom-kolom di bawah ini terkait dengan alat yang dibutuhkan untuk mendeteksi makanan yang mengandung borak, karakteristik setiap jenis alat, faktor yang menyebabkan alat-alat tersebut efektif digunakan, dan biaya pembuatan untuk tiap jenisnya.\r\n',2,'2024-07-27 13:39:16',NULL),(47,15,2,'Dari beberapa prototipe yang kamu ketahui, jenis manakah yang terbaik menurutmu? Berikan alasanmu dengan mempertimbangkan aspek ekonomi dan lingkungan!',2,'2024-07-27 13:39:37',NULL),(48,15,3,'Dari beberapa pendeteksi makanan mengandung borak yang kamu ketahui, jenis manakah yang terbaik menurutmu? Berikan alasanmu dengan mempertimbangkan aspek ekonomi dan lingkungan!',2,'2024-07-27 13:39:57',NULL),(49,15,4,'Buatlah pertanyaan tambahan beserta jawabannya untuk mendapatkan informasi lebih tentang alat tersebut. Tuliskan pertanyaan dan jawabanmu dalam kolom berikut!',2,'2024-07-27 13:40:12',NULL),(50,15,5,'Sebelum merancang dan membuat proyek buatlah hipotesis penyelidikanmu pada kolom di bawah ini, berdasarkan informasi yang telah kamu peroleh sebelumnya. Tujuannya agar penyelidikan yang kamu lakukan menjadi terarah, memeriksa fakta dan hubungan variabel serta membimbing penelitianmu dalam pengujian dan penyesuaian fakta.',2,'2024-07-27 13:40:26',NULL),(51,16,1,'Keterangan / Penjelasan bagian-bagian produk:',2,'2024-07-27 13:41:44',NULL),(52,16,2,'Inovasi',2,'2024-07-27 13:42:07',NULL),(53,16,3,'Biaya yang dibutuhkan',2,'2024-07-27 13:42:26',NULL),(54,17,1,'Nama alat',1,'2024-07-27 13:43:22','2024-07-27 13:43:41'),(55,17,2,'Tujuan',2,'2024-07-27 13:44:10',NULL),(56,17,3,'Alat dan Bahan',2,'2024-07-27 13:44:24',NULL),(57,17,4,'Buatlah langkah-langkah pembuatan proyek',2,'2024-07-27 13:44:46',NULL),(58,18,1,'[Uji Coba 1] Bagaimana cara menguji efektivitas prototipe/produk yang kamu buat?',2,'2024-07-27 13:45:49',NULL),(59,18,2,'[Uji Coba 1] Lakukan uji coba efektivitas produk sesuai dengan cara pengujian yang telah kamu susun! Sajikan hasil uji coba 1 yang telah kamu peroleh!',2,'2024-07-27 13:46:10',NULL),(60,18,3,'[Uji Coba 1] Evaluasi hasil dari uji coba 1 yang telah dilakukan! Adakah hal-hal yang perlu ditingkatkan dari desain produk yang diujicobakan tersebut? Jelaskan!',2,'2024-07-27 13:46:29',NULL),(61,18,4,'[Redisain] Berdasarkan hasil uji coba 1, Jelaskanlah perubahan apa yang akan kamu lakukan dari rancangan awal produkmu?',2,'2024-07-27 13:46:46',NULL),(62,18,5,'[Redisain] Bagaimana bentuk rancangan akhir produkmu? & Buatlah rancangan akhir tersebut!',2,'2024-07-27 13:47:06',NULL),(63,18,6,'[Uji Coba 2] Lakukan uji coba 2 dengan langkah yang sama dengan uji coba 1 untuk melihat efektivitas produk akhir yang kamu buat!',2,'2024-07-27 13:47:28',NULL),(64,18,7,'[Uji Coba 2] Berdasarkan hasil uji coba 2, apakah kesimpulanmu?',2,'2024-07-27 13:47:53',NULL),(65,19,1,'Gambar Disain Produk',4,'2024-07-27 13:49:25',NULL),(66,19,2,'Keterangan / Penjelasan bagian-bagian produk:',2,'2024-07-27 13:49:38',NULL),(67,19,3,'Inovasi',2,'2024-07-27 13:49:52',NULL),(68,19,4,'Biaya yang dibutuhkan',2,'2024-07-27 13:50:06',NULL),(69,19,5,'Silahkan persiapkan bahan presentasi terkait inovasi/ kebaruan yang diperbaiki atau ditambahkan dari prototype yang telah di buat. Silahkan upload file PPT yang digunakan untuk presentasi.',3,'2024-07-27 13:50:28',NULL),(70,20,1,'Silahkan beri tanggapan terhadap terhadap prototype yang telah dibuat',2,'2024-07-27 13:52:10',NULL),(71,6,5,'Unggah file bukti dokumentasi hasil eksplorasi (.pdf) ',3,'2024-10-03 18:56:59',NULL),(72,14,5,'Unggah file bukti dokumentasi hasil eksplorasi (.pdf) ',3,'2024-10-03 18:57:16',NULL);

/*Table structure for table `tb_test_unity` */

DROP TABLE IF EXISTS `tb_test_unity`;

CREATE TABLE `tb_test_unity` (
  `id_test_unity` int(11) NOT NULL AUTO_INCREMENT,
  `id_user` int(11) NOT NULL,
  `indikator_soal` varchar(500) NOT NULL,
  `practice` varchar(255) NOT NULL,
  `pertanyaan` text NOT NULL,
  `jawaban` text NOT NULL,
  `nilai` int(11) DEFAULT NULL,
  `feedback` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id_test_unity`),
  KEY `FK_tb_test_unity` (`id_user`),
  CONSTRAINT `FK_tb_test_unity` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `tb_test_unity` */

insert  into `tb_test_unity`(`id_test_unity`,`id_user`,`indikator_soal`,`practice`,`pertanyaan`,`jawaban`,`nilai`,`feedback`) values (1,16,'alal1','llala','alalla\r\n','alala',70,NULL),(2,16,'lili','lili','lilolo','llilililili',70,NULL);

/*Table structure for table `tb_type_form` */

DROP TABLE IF EXISTS `tb_type_form`;

CREATE TABLE `tb_type_form` (
  `id_type_form` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `tb_type_form` */

insert  into `tb_type_form`(`id_type_form`,`type_form`,`created_at`,`updated_at`) values (1,'input text (isian singkat)','2024-07-03 12:47:44',NULL),(2,'textarea (isian panjang)','2024-07-03 12:47:46',NULL),(3,'file','2024-07-03 12:47:49',NULL),(4,'canva (menggambar)','2024-07-03 12:48:00',NULL);
...
CREATE TABLE `tb_user` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id_user`),
  KEY `FK_tb_user` (`id_role_user`),
  CONSTRAINT `FK_tb_user` FOREIGN KEY (`id_role_user`) REFERENCES `tb_role_user` (`id_role_user`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `tb_user` */

insert  into `tb_user`(`id_user`,`id_role_user`,`nama_lengkap`,`angkatan`,`sekolah`,`email`,`tanggal_lahir`,`jenis_kelamin`,`foto_profil`,`username`,`password`,`created_at`,`updated_at`) values (2,2,'Dwi Fitria Al Husaeni',NULL,'Universitas Pendidikan Indonesia','dwi99@gmail.com','2000-12-14','P','e13033a66a4f54093beb305c25cfe684.jpg','guru','77e69c137812518e359196bb2f5e9bb9','2024-06-22 13:00:08','2024-07-03 07:17:09'),(8,2,'Yadi Subekti',NULL,'UPI','yadiS76@gmail.com','1986-11-12','L','0eb99d44a4c951084be8c740845acded.jpg','yadi','e60838b9f0c0ed98a486f231a4df9c4a','2024-06-27 11:50:48',NULL),(12,2,'lili',NULL,'UPI','lisaamrimubarokah22@upi.edu','2000-12-12','P','6e02d6fa6e97d7fede5974b13d2c1f5e.jpeg','lili','777bbb7869ae8193249f8ff7d3e59afe','2024-10-04 13:17:14',NULL),(15,1,'Dwi Fitria Al Husaeni','2019','Universitas Pendidikan Indonesia','dwifitriaalhusaeni@upi.edu','2000-12-14','P','b19e17998e388019457808da5286885f.jpg','dwi','7aa2602c588c05a93baf10128861aeb9','2024-10-06 08:07:20',NULL),(16,1,'Syahraeni Nur Mala','2019','Universitas Pendidikan Indonesia','shahnazir@uoswabi.edu.pk','1998-12-12','P','3d8b206067a6db6f2f6ec8b848703a23.jpg','lala','2e3817293fc275dbee74bd71ce6eb056','2024-10-07 05:34:48',NULL);

/*Table structure for table `v_alur_pembelajaran` */

DROP TABLE IF EXISTS `v_alur_pembelajaran`;

/*!50001 DROP VIEW IF EXISTS `v_alur_pembelajaran` */;
/*!50001 DROP TABLE IF EXISTS `v_alur_pembelajaran` */;

/*!50001 CREATE TABLE `v_alur_pembelajaran` (
  `judul_pertemuan` varchar(100) NOT NULL,
  `no_pertemuan` int(11) NOT NULL,
  `deskripsi_pertemuan` text DEFAULT NULL,
  `status_pertemuan` char(1) NOT NULL,
  ...
  `link_rps` text DEFAULT NULL,
  `semester` int(11) NOT NULL,
  `status_mata_kuliah` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci */;

/*Table structure for table `v_diskusi` */

DROP TABLE IF EXISTS `v_diskusi`;

/*!50001 DROP VIEW IF EXISTS `v_diskusi` */;
/*!50001 DROP TABLE IF EXISTS `v_diskusi` */;

/*!50001 CREATE TABLE `v_diskusi` (
...
/*Table structure for table `v_jawaban_essai` */

DROP TABLE IF EXISTS `v_jawaban_essai`;

/*!50001 DROP VIEW IF EXISTS `v_jawaban_essai` */;
/*!50001 DROP TABLE IF EXISTS `v_jawaban_essai` */;

/*!50001 CREATE TABLE `v_jawaban_essai` (
...
/*Table structure for table `v_nilai_worksheet` */

DROP TABLE IF EXISTS `v_nilai_worksheet`;

/*!50001 DROP VIEW IF EXISTS `v_nilai_worksheet` */;
/*!50001 DROP TABLE IF EXISTS `v_nilai_worksheet` */;

/*!50001 CREATE TABLE `v_nilai_worksheet` (
  `id_user` int(11) NOT NULL,
  `angkatan` varchar(10) DEFAULT NULL,
  `nama_lengkap` varchar(255) NOT NULL,
  `jenis_kelamin` char(1) NOT NULL,
  ...
  `id_pertemuan` int(11) NOT NULL,
  `no_pertemuan` int(11) NOT NULL,
  `nilai_per_pertemuan` decimal(32,0) DEFAULT NULL,
  `total_score` decimal(32,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci */;

/*Table structure for table `v_nilai_worksheet_tahapan` */

DROP TABLE IF EXISTS `v_nilai_worksheet_tahapan`;

/*!50001 DROP VIEW IF EXISTS `v_nilai_worksheet_tahapan` */;
/*!50001 DROP TABLE IF EXISTS `v_nilai_worksheet_tahapan` */;

/*!50001 CREATE TABLE `v_nilai_worksheet_tahapan` (
  `id_jawaban_essai` int(11) NOT NULL DEFAULT 0,
  `id_user` int(11) NOT NULL,
  `jawaban_file` text DEFAULT NULL,
  `jawaban_gambar` text DEFAULT NULL,
  `jawaban_text` text DEFAULT NULL,
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `total_skor` decimal(32,0) DEFAULT NULL,
  `nama_lengkap` varchar(255) NOT NULL,
  `angkatan` varchar(10) DEFAULT NULL,
  `email` varchar(150) NOT NULL,
  `foto_profil` varchar(255) DEFAULT NULL,
  ...
  `username` varchar(50) NOT NULL,
  `deksripsi_soal` text NOT NULL,
  `id_soal_essai` int(11) NOT NULL DEFAULT 0,
  `no_soal` int(11) NOT NULL,
  `tipe_jawaban` int(11) NOT NULL,
  `deskripsi_permasalahan` text NOT NULL,
  `foto` text DEFAULT NULL,
  `id_permasalahan` int(11) NOT NULL DEFAULT 0,
  `id_pertemuan` int(11) NOT NULL,
  `judul_permasalahan` varchar(500) DEFAULT NULL,
  `jumlah_soal` int(11) NOT NULL,
  `link_permasalahan` text DEFAULT NULL,
...
/*Table structure for table `v_permasalahan` */

DROP TABLE IF EXISTS `v_permasalahan`;

/*!50001 DROP VIEW IF EXISTS `v_permasalahan` */;
/*!50001 DROP TABLE IF EXISTS `v_permasalahan` */;

/*!50001 CREATE TABLE `v_permasalahan` (
  `id_permasalahan` int(11) NOT NULL,
  `id_pertemuan` int(11) NOT NULL,
  `tahapan_pembelajaran` varchar(50) DEFAULT NULL,
  `judul_permasalahan` varchar(500) DEFAULT NULL,
...
/*Table structure for table `v_score` */

DROP TABLE IF EXISTS `v_score`;

/*!50001 DROP VIEW IF EXISTS `v_score` */;
/*!50001 DROP TABLE IF EXISTS `v_score` */;

/*!50001 CREATE TABLE `v_score` (
...
/*Table structure for table `v_soal_essai` */

DROP TABLE IF EXISTS `v_soal_essai`;

/*!50001 DROP VIEW IF EXISTS `v_soal_essai` */;
/*!50001 DROP TABLE IF EXISTS `v_soal_essai` */;

/*!50001 CREATE TABLE `v_soal_essai` (
  `id_soal_essai` int(11) NOT NULL,
  `id_permasalahan` int(11) NOT NULL,
  `no_soal` int(11) NOT NULL,
  `deksripsi_soal` text NOT NULL,
...
/*Table structure for table `v_test_unity` */

DROP TABLE IF EXISTS `v_test_unity`;

/*!50001 DROP VIEW IF EXISTS `v_test_unity` */;
/*!50001 DROP TABLE IF EXISTS `v_test_unity` */;

/*!50001 CREATE TABLE `v_test_unity` (
  `id_user` int(11) NOT NULL,
  `id_role_user` int(11) NOT NULL,
  `nama_lengkap` varchar(255) NOT NULL,
  `angkatan` varchar(10) DEFAULT NULL,
...
/*Table structure for table `v_total_score` */

DROP TABLE IF EXISTS `v_total_score`;

/*!50001 DROP VIEW IF EXISTS `v_total_score` */;
/*!50001 DROP TABLE IF EXISTS `v_total_score` */;

/*!50001 CREATE TABLE `v_total_score` (
  `id_user` int(11) DEFAULT NULL,
  `score_pretest` int(11) DEFAULT NULL,
  `score_posttest` int(11) DEFAULT NULL,
  `score_total_worksheet` decimal(33,0) DEFAULT NULL,
  `total_score` decimal(34,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci */;

/*Table structure for table `v_total_score_2` */

DROP TABLE IF EXISTS `v_total_score_2`;

/*!50001 DROP VIEW IF EXISTS `v_total_score_2` */;
/*!50001 DROP TABLE IF EXISTS `v_total_score_2` */;

/*!50001 CREATE TABLE `v_total_score_2` (
  `id_user` int(11) DEFAULT NULL,
  `score_total_worksheet` decimal(33,0) DEFAULT NULL,
  `score_unity` decimal(32,0) DEFAULT NULL,
  `total_score` decimal(34,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci */;
...
/*View structure for view v_alur_pembelajaran */
...
/*View structure for view v_diskusi */

/*!50001 DROP TABLE IF EXISTS `v_diskusi` */;
/*!50001 DROP VIEW IF EXISTS `v_diskusi` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=CURRENT_USER SQL SECURITY DEFINER VIEW `v_diskusi` AS select `tb_diskusi`.`id_diskusi` AS `id_diskusi`,`tb_diskusi`.`id_user` AS `id_user`,`tb_diskusi`.`id_pertemuan` AS `id_pertemuan`,`tb_diskusi`.`komentar` AS `komentar`,`tb_diskusi`.`created_at` AS `created_at`,`tb_diskusi`.`updated_at` AS `updated_at`,`tb_pertemuan`.`judul_pertemuan` AS `judul_pertemuan`,`tb_pertemuan`.`no_pertemuan` AS `no_pertemuan`,`tb_pertemuan`.`deskripsi_pertemuan` AS `deskripsi_pertemuan`,`tb_pertemuan`.`status` AS `status`,`tb_user`.`email` AS `email`,`tb_user`.`angkatan` AS `angkatan`,`tb_user`.`foto_profil` AS `foto_profil`,`tb_user`.`id_role_user` AS `id_role_user`,`tb_user`.`jenis_kelamin` AS `jenis_kelamin`,`tb_user`.`nama_lengkap` AS `nama_lengkap`,`tb_user`.`password` AS `password`,`tb_user`.`sekolah` AS `sekolah`,`tb_user`.`tanggal_lahir` AS `tanggal_lahir`,`tb_role_user`.`role_user` AS `role_user` from (((`tb_diskusi` join `tb_pertemuan` on(`tb_diskusi`.`id_pertemuan` = `tb_pertemuan`.`id_pertemuan`)) join `tb_user` on(`tb_diskusi`.`id_user` = `tb_user`.`id_user`)) join `tb_role_user` on(`tb_role_user`.`id_role_user` = `tb_user`.`id_role_user`)) */;

/*View structure for view v_jawaban_essai */

/*!50001 DROP TABLE IF EXISTS `v_jawaban_essai` */;
/*!50001 DROP VIEW IF EXISTS `v_jawaban_essai` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=CURRENT_USER SQL SECURITY DEFINER VIEW `v_jawaban_essai` AS select `tb_jawaban_essai`.`id_jawaban_essai` AS `id_jawaban_essai`,`tb_jawaban_essai`.`id_soal` AS `id_soal`,`tb_jawaban_essai`.`id_user` AS `id_user`,`tb_jawaban_essai`.`jawaban_text` AS `jawaban_text`,`tb_jawaban_essai`.`jawaban_file` AS `jawaban_file`,`tb_jawaban_essai`.`jawaban_gambar` AS `jawaban_gambar`,`tb_jawaban_essai`.`nilai` AS `nilai`,`tb_jawaban_essai`.`feedback` AS `feedback`,`tb_jawaban_essai`.`created_at` AS `created_at`,`tb_jawaban_essai`.`updated_at` AS `updated_at`,`tb_soal_essai`.`deksripsi_soal` AS `deksripsi_soal`,`tb_soal_essai`.`id_permasalahan` AS `id_permasalahan`,`tb_soal_essai`.`no_soal` AS `no_soal`,`tb_soal_essai`.`id_soal_essai` AS `id_soal_essai`,`tb_soal_essai`.`tipe_jawaban` AS `tipe_jawaban`,`tb_user`.`email` AS `email`,`tb_user`.`foto_profil` AS `foto_profil`,`tb_user`.`angkatan` AS `angkatan`,`tb_user`.`id_role_user` AS `id_role_user`,`tb_user`.`jenis_kelamin` AS `jenis_kelamin`,`tb_user`.`nama_lengkap` AS `nama_lengkap`,`tb_user`.`password` AS `password`,`tb_user`.`sekolah` AS `sekolah`,`tb_user`.`tanggal_lahir` AS `tanggal_lahir`,`tb_user`.`username` AS `username` from ((`tb_jawaban_essai` join `tb_soal_essai` on(`tb_jawaban_essai`.`id_soal` = `tb_soal_essai`.`id_soal_essai`)) join `tb_user` on(`tb_jawaban_essai`.`id_user` = `tb_user`.`id_user`)) */;

/*View structure for view v_nilai_worksheet */

/*!50001 DROP TABLE IF EXISTS `v_nilai_worksheet` */;
/*!50001 DROP VIEW IF EXISTS `v_nilai_worksheet` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=CURRENT_USER SQL SECURITY DEFINER VIEW `v_nilai_worksheet` AS select `js`.`id_user` AS `id_user`,`us`.`angkatan` AS `angkatan`,`us`.`nama_lengkap` AS `nama_lengkap`,`us`.`jenis_kelamin` AS `jenis_kelamin`,`us`.`username` AS `username`,`us`.`sekolah` AS `sekolah`,`pm`.`id_pertemuan` AS `id_pertemuan`,`pt`.`no_pertemuan` AS `no_pertemuan`,sum(`js`.`nilai`) AS `nilai_per_pertemuan`,(select sum(`js2`.`nilai`) from ((`tb_jawaban_essai` `js2` join `tb_soal_essai` `s2` on(`js2`.`id_soal` = `s2`.`id_soal_essai`)) join `tb_permasalahan` `pm2` on(`s2`.`id_permasalahan` = `pm2`.`id_permasalahan`)) where `js2`.`id_user` = `js`.`id_user`) AS `total_score` from ((((`tb_jawaban_essai` `js` join `tb_user` `us` on(`js`.`id_user` = `us`.`id_user`)) join `tb_soal_essai` `s` on(`js`.`id_soal` = `s`.`id_soal_essai`)) join `tb_permasalahan` `pm` on(`s`.`id_permasalahan` = `pm`.`id_permasalahan`)) join `tb_pertemuan` `pt` on(`pm`.`id_pertemuan` = `pt`.`id_pertemuan`)) group by `js`.`id_user`,`pm`.`id_pertemuan` */;

/*View structure for view v_nilai_worksheet_tahapan */

/*!50001 DROP TABLE IF EXISTS `v_nilai_worksheet_tahapan` */;
/*!50001 DROP VIEW IF EXISTS `v_nilai_worksheet_tahapan` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=CURRENT_USER SQL SECURITY DEFINER VIEW `v_nilai_worksheet_tahapan` AS select `tb_jawaban_essai`.`id_jawaban_essai` AS `id_jawaban_essai`,`tb_jawaban_essai`.`id_user` AS `id_user`,`tb_jawaban_essai`.`jawaban_file` AS `jawaban_file`,`tb_jawaban_essai`.`jawaban_gambar` AS `jawaban_gambar`,`tb_jawaban_essai`.`jawaban_text` AS `jawaban_text`,`tb_jawaban_essai`.`nilai` AS `nilai`,`tb_jawaban_essai`.`created_at` AS `created_at`,`tb_jawaban_essai`.`updated_at` AS `updated_at`,sum(`tb_jawaban_essai`.`nilai`) AS `total_skor`,`tb_user`.`nama_lengkap` AS `nama_lengkap`,`tb_user`.`angkatan` AS `angkatan`,`tb_user`.`email` AS `email`,`tb_user`.`foto_profil` AS `foto_profil`,`tb_user`.`id_role_user` AS `id_role_user`,`tb_user`.`jenis_kelamin` AS `jenis_kelamin`,`tb_user`.`sekolah` AS `sekolah`,`tb_user`.`tanggal_lahir` AS `tanggal_lahir`,`tb_user`.`username` AS `username`,`tb_soal_essai`.`deksripsi_soal` AS `deksripsi_soal`,`tb_soal_essai`.`id_soal_essai` AS `id_soal_essai`,`tb_soal_essai`.`no_soal` AS `no_soal`,`tb_soal_essai`.`tipe_jawaban` AS `tipe_jawaban`,`tb_permasalahan`.`deskripsi_permasalahan` AS `deskripsi_permasalahan`,`tb_permasalahan`.`foto` AS `foto`,`tb_permasalahan`.`id_permasalahan` AS `id_permasalahan`,`tb_permasalahan`.`id_pertemuan` AS `id_pertemuan`,`tb_permasalahan`.`judul_permasalahan` AS `judul_permasalahan`,`tb_permasalahan`.`jumlah_soal` AS `jumlah_soal`,`tb_permasalahan`.`link_permasalahan` AS `link_permasalahan`,`tb_permasalahan`.`tahapan_pembelajaran` AS `tahapan_pembelajaran`,`tb_pertemuan`.`no_pertemuan` AS `no_pertemuan`,`tb_pertemuan`.`judul_pertemuan` AS `judul_pertemuan`,`tb_pertemuan`.`deskripsi_pertemuan` AS `deskripsi_pertemuan`,`tb_pertemuan`.`status` AS `status` from ((((`tb_jawaban_essai` join `tb_user` on(`tb_jawaban_essai`.`id_user` = `tb_user`.`id_user`)) join `tb_soal_essai` on(`tb_jawaban_essai`.`id_soal` = `tb_soal_essai`.`id_soal_essai`)) join `tb_permasalahan` on(`tb_soal_essai`.`id_permasalahan` = `tb_permasalahan`.`id_permasalahan`)) join `tb_pertemuan` on(`tb_permasalahan`.`id_pertemuan` = `tb_pertemuan`.`id_pertemuan`)) group by `tb_jawaban_essai`.`id_user`,`tb_permasalahan`.`tahapan_pembelajaran` */;

/*View structure for view v_permasalahan */
...
/*View structure for view v_test_unity */

/*!50001 DROP TABLE IF EXISTS `v_test_unity` */;
/*!50001 DROP VIEW IF EXISTS `v_test_unity` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=CURRENT_USER SQL SECURITY DEFINER VIEW `v_test_unity` AS select `tb_user`.`id_user` AS `id_user`,`tb_user`.`id_role_user` AS `id_role_user`,`tb_user`.`nama_lengkap` AS `nama_lengkap`,`tb_user`.`angkatan` AS `angkatan`,`tb_user`.`sekolah` AS `sekolah`,`tb_user`.`email` AS `email`,`tb_user`.`tanggal_lahir` AS `tanggal_lahir`,`tb_user`.`jenis_kelamin` AS `jenis_kelamin`,`tb_user`.`foto_profil` AS `foto_profil`,`tb_user`.`username` AS `username`,`tb_user`.`password` AS `password`,`tb_user`.`created_at` AS `created_at`,`tb_user`.`updated_at` AS `updated_at`,`tb_test_unity`.`id_test_unity` AS `id_test_unity`,`tb_test_unity`.`indikator_soal` AS `indikator_soal`,`tb_test_unity`.`pertanyaan` AS `pertanyaan`,`tb_test_unity`.`practice` AS `practice`,`tb_test_unity`.`jawaban` AS `jawaban`,`tb_test_unity`.`nilai` AS `nilai`,`tb_test_unity`.`feedback` AS `feedback` from (`tb_user` join `tb_test_unity` on(`tb_user`.`id_user` = `tb_test_unity`.`id_user`)) */;

/*View structure for view v_total_score */

/*!50001 DROP TABLE IF EXISTS `v_total_score` */;
/*!50001 DROP VIEW IF EXISTS `v_total_score` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=CURRENT_USER SQL SECURITY DEFINER VIEW `v_total_score` AS select coalesce(`ws`.`id_user`,`s`.`id_user`) AS `id_user`,coalesce(`s`.`score_pretest`,0) AS `score_pretest`,coalesce(`s`.`score_posttest`,0) AS `score_posttest`,coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) AS `score_total_worksheet`,coalesce(`s`.`score_pretest`,0) + coalesce(`s`.`score_posttest`,0) + coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) AS `total_score` from ((select `js`.`id_user` AS `id_user`,sum(`js`.`nilai`) AS `total_nilai_worksheet` from (((`tb_jawaban_essai` `js` join `tb_soal_essai` `se` on(`js`.`id_soal` = `se`.`id_soal_essai`)) join `tb_permasalahan` `pm` on(`se`.`id_permasalahan` = `pm`.`id_permasalahan`)) join `tb_pertemuan` `pt` on(`pm`.`id_pertemuan` = `pt`.`id_pertemuan`)) group by `js`.`id_user`) `ws` left join `tb_score` `s` on(`ws`.`id_user` = `s`.`id_user`)) union select `s`.`id_user` AS `id_user`,coalesce(`s`.`score_pretest`,0) AS `score_pretest`,coalesce(`s`.`score_posttest`,0) AS `score_posttest`,coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) AS `score_total_worksheet`,coalesce(`s`.`score_pretest`,0) + coalesce(`s`.`score_posttest`,0) + coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) AS `total_score` from (`tb_score` `s` left join (select `js`.`id_user` AS `id_user`,sum(`js`.`nilai`) AS `total_nilai_worksheet` from (((`tb_jawaban_essai` `js` join `tb_soal_essai` `se` on(`js`.`id_soal` = `se`.`id_soal_essai`)) join `tb_permasalahan` `pm` on(`se`.`id_permasalahan` = `pm`.`id_permasalahan`)) join `tb_pertemuan` `pt` on(`pm`.`id_pertemuan` = `pt`.`id_pertemuan`)) group by `js`.`id_user`) `ws` on(`s`.`id_user` = `ws`.`id_user`)) */;

/*View structure for view v_total_score_2 */

/*!50001 DROP TABLE IF EXISTS `v_total_score_2` */;
/*!50001 DROP VIEW IF EXISTS `v_total_score_2` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=CURRENT_USER SQL SECURITY DEFINER VIEW `v_total_score_2` AS select coalesce(`ws`.`id_user`,`s`.`id_user`,`tu`.`id_user`) AS `id_user`,coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) AS `score_total_worksheet`,coalesce(`tu`.`total_nilai_unity`,0) AS `score_unity`,coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) + coalesce(`tu`.`total_nilai_unity`,0) AS `total_score` from (((select `js`.`id_user` AS `id_user`,sum(`js`.`nilai`) AS `total_nilai_worksheet` from (((`tb_jawaban_essai` `js` join `tb_soal_essai` `se` on(`js`.`id_soal` = `se`.`id_soal_essai`)) join `tb_permasalahan` `pm` on(`se`.`id_permasalahan` = `pm`.`id_permasalahan`)) join `tb_pertemuan` `pt` on(`pm`.`id_pertemuan` = `pt`.`id_pertemuan`)) group by `js`.`id_user`) `ws` left join `tb_score` `s` on(`ws`.`id_user` = `s`.`id_user`)) left join (select `tb_test_unity`.`id_user` AS `id_user`,sum(`tb_test_unity`.`nilai`) AS `total_nilai_unity` from `tb_test_unity` group by `tb_test_unity`.`id_user`) `tu` on(`ws`.`id_user` = `tu`.`id_user`)) union select coalesce(`ws`.`id_user`,`s`.`id_user`,`tu`.`id_user`) AS `id_user`,coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) AS `score_total_worksheet`,coalesce(`tu`.`total_nilai_unity`,0) AS `score_unity`,coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) + coalesce(`tu`.`total_nilai_unity`,0) AS `total_score` from ((`tb_score` `s` left join (select `js`.`id_user` AS `id_user`,sum(`js`.`nilai`) AS `total_nilai_worksheet` from (((`tb_jawaban_essai` `js` join `tb_soal_essai` `se` on(`js`.`id_soal` = `se`.`id_soal_essai`)) join `tb_permasalahan` `pm` on(`se`.`id_permasalahan` = `pm`.`id_permasalahan`)) join `tb_pertemuan` `pt` on(`pm`.`id_pertemuan` = `pt`.`id_pertemuan`)) group by `js`.`id_user`) `ws` on(`s`.`id_user` = `ws`.`id_user`)) left join (select `tb_test_unity`.`id_user` AS `id_user`,sum(`tb_test_unity`.`nilai`) AS `total_nilai_unity` from `tb_test_unity` group by `tb_test_unity`.`id_user`) `tu` on(`s`.`id_user` = `tu`.`id_user`)) union select `tu`.`id_user` AS `id_user`,coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) AS `score_total_worksheet`,coalesce(`tu`.`total_nilai_unity`,0) AS `score_unity`,coalesce(`ws`.`total_nilai_worksheet`,0) + coalesce(`s`.`score_pertemuan`,0) + coalesce(`tu`.`total_nilai_unity`,0) AS `total_score` from (((select `tb_test_unity`.`id_user` AS `id_user`,sum(`tb_test_unity`.`nilai`) AS `total_nilai_unity` from `tb_test_unity` group by `tb_test_unity`.`id_user`) `tu` left join (select `js`.`id_user` AS `id_user`,sum(`js`.`nilai`) AS `total_nilai_worksheet` from (((`tb_jawaban_essai` `js` join `tb_soal_essai` `se` on(`js`.`id_soal` = `se`.`id_soal_essai`)) join `tb_permasalahan` `pm` on(`se`.`id_permasalahan` = `pm`.`id_permasalahan`)) join `tb_pertemuan` `pt` on(`pm`.`id_pertemuan` = `pt`.`id_pertemuan`)) group by `js`.`id_user`) `ws` on(`tu`.`id_user` = `ws`.`id_user`)) left join `tb_score` `s` on(`tu`.`id_user` = `s`.`id_user`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=CURRENT_USER SQL SECURITY DEFINER VIEW `v_user` AS select `tb_user`.`id_user` AS `id_user`,`tb_user`.`id_role_user` AS `id_role_user`,`tb_role_user`.`role_user` AS `role_user`,`tb_user`.`nama_lengkap` AS `nama_lengkap`,`tb_user`.`angkatan` AS `angkatan`,`tb_user`.`sekolah` AS `sekolah`,`tb_user`.`email` AS `email`,`tb_user`.`jenis_kelamin` AS `jenis_kelamin`,`tb_user`.`tanggal_lahir` AS `tanggal_lahir`,`tb_user`.`foto_profil` AS `foto_profil`,`tb_user`.`username` AS `username`,`tb_user`.`password` AS `password`,`tb_user`.`created_at` AS `created_at`,`tb_user`.`updated_at` AS `updated_at` from (`tb_user` join `tb_role_user` on(`tb_user`.`id_role_user` = `tb_role_user`.`id_role_user`)) */;
